...
## Open science across the research lifecycle {.nostretch}

![Open science principles throughout the research process [@centerforopensciencewhat]](assets/images/lifecycle-practices.png){fig-alt="Open science practices across the research lifecycle" width="70%" fig-align="center"}

::: {.key-point}
Open science encourges you to share all data, code, and materials, but there are situations where you cannot (e.g., protected health information).
:::
...
::: {.notes}
- You can stage many times before committing.
- You can commit many times before pushing.
...
::: {.notes}
- **GitHub Copilot** is a coding assistant. It can dynamically choose what model to use depending on the task you give it -- simple tasks can be solved by simple models.
- Other coding assistants include OpenAI Codex and Claude Code.
:::
